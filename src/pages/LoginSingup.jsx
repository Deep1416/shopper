      ...
      <div className="md:w-[580px] h-[600px] bg-white m-auto py-[40px] px-[60px]">
        ...
        <div className="flex flex-col md:gap-[30px] gap-5 mt-[30px] relative">
          ...
          <div className="relative">
            ...
            >
              {showPassword ? (
                <FaEye className="text-3xl text-[#5c5c5c]" />
              ) : (
                <FaEyeSlash className="text-3xl text-[#5c5c5c]" />
              )}
            </span>
          </div>
        </div>
        <motion.button
          whileTap={{ scale: "0.9" }}
          onClick={handleSign}
          className="md:w-[450px] md:h-[42px]  px-4 md:px-0 text-white bg-[#ff4141]  md:mt-[30px] border-none  text-base md:text-2xl font-medium   rounded-md cursor-pointer"
        >
          Continue
        </motion.button>
