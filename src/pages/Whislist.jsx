    ...
    <>
      {whislistItems.length === 0 ? (
        <div className="flex justify-center items-center flex-col pt-20">
          ...
          <NavLink to={"/"}>
            <button className="mt-3 mb-48 px-10 text-lg font-semibold py-2 bg-red-500">
              Shop Now
            </button>
          </NavLink>
        </div>
              ...
              <div className="pt-2" key={i}>
                ...
                <div className="flex gap-2 pt-4">
                  ...
                  <button
                    ...
                    className="py-2 px-5 w-[102px] text-base text-white font-semibold bg-[#ff4141] mb-10 border-none outline-none"
                  >
                    Remove
                  </button>
                </div>
