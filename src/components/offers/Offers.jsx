  ...
  return (
    <div className='offers'>
      <div className='flex-1 flex flex-col justify-center md:w-full md:justify-start'>
        ...
        <button className='md:w-[282px] w-[102px]  md:h-[70px] h-[35px] bg-[#ff4141] border-none text-white text-[22px] rounded-[35px] font-medium mt-[30px] cursor-pointer'>Check Now</button>
      </div>
