    ...
    <>
      ...
      {cartSlice.length === 0 ? (
        <div className=" w-[40%] m-auto pb-28 flex flex-col justify-center items-center">
          ...
          <NavLink to={"/"}>
            <button className=" px-6 md:px-12 py-1 md:py-4 text-lg font-semibold  bg-red-500 ">
              Continue Shopping
            </button>
          </NavLink>
        </div>
        ...
        <div className=" mx-4 my-4 md:mx-16 md:my-12 flex gap-10 flex-wrap md:flex-nowrap">
          <div className="md:w-1/2">
            ...
            {cartSlice.map((e, i) => {
              return (
                <div
                  key={i}
                  className="border-2 border-gray-200 px-3 py-2 mb-10"
                >
                  ...
                  <div className=" flex justify-center gap-2 items-center">
                    <button
                      ...
                      className="px-3 md:px-6 py-1 md:py-2 md:w-full text-lg font-medium bg-red-500 rounded-md "
                    >
                      Remove
                    </button>
                    <button
          ...
          <div className="md:w-1/2 h-[420px] mt-12 border-2 border-gray-200">
